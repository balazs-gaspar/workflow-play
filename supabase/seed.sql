...
INSERT INTO task_instances (id, module_instance_id, task_definition_id, workflow_instance_id, status, owner, team, due_date, started_at, completed_at) VALUES
  -- Task instances for mod-inst-001-001 (Discovery & Planning - completed)
  ('task-inst-001-001-001', 'mod-inst-001-001', 'task-def-001', 'wf-inst-001', 'completed', '{"id": "user-006", "name": "Emily Davis"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-15T17:00:00Z', '2026-01-15T10:00:00Z', '2026-01-15T16:00:00Z'),
  ('task-inst-001-001-002', 'mod-inst-001-001', 'task-def-002', 'wf-inst-001', 'completed', '{"id": "user-035", "name": "Joshua Green"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-16T18:00:00Z', '2026-01-16T09:00:00Z', '2026-01-16T17:00:00Z'),
  ('task-inst-001-001-003', 'mod-inst-001-001', 'task-def-003', 'wf-inst-001', 'completed', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-17T18:00:00Z', '2026-01-17T09:00:00Z', '2026-01-17T15:00:00Z'),
  ('task-inst-001-001-004', 'mod-inst-001-001', 'task-def-004', 'wf-inst-001', 'completed', '{"id": "user-006", "name": "Emily Davis"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-18T18:00:00Z', '2026-01-18T09:00:00Z', '2026-01-18T12:00:00Z'),
  ('task-inst-001-001-009', 'mod-inst-001-001', 'task-def-009', 'wf-inst-001', 'completed', '{"id": "user-005", "name": "David Brown"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-19T18:00:00Z', '2026-01-19T09:00:00Z', '2026-01-19T14:00:00Z'),
  ('task-inst-001-001-010', 'mod-inst-001-001', 'task-def-010', 'wf-inst-001', 'completed', '{"id": "user-005", "name": "David Brown"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-20T18:00:00Z', '2026-01-20T10:00:00Z', '2026-01-20T11:30:00Z'),
  
  -- Task instances for mod-inst-001-002 (Documentation & Compliance - completed)
  ('task-inst-001-002-011', 'mod-inst-001-002', 'task-def-011', 'wf-inst-001', 'completed', '{"id": "user-048", "name": "Kathleen Evans"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-22T18:00:00Z', '2026-01-21T09:00:00Z', '2026-01-22T17:00:00Z'),
  ('task-inst-001-002-012', 'mod-inst-001-002', 'task-def-012', 'wf-inst-001', 'completed', '{"id": "user-021", "name": "Charles Clark"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-23T18:00:00Z', '2026-01-23T09:00:00Z', '2026-01-23T16:00:00Z'),
  ('task-inst-001-002-014', 'mod-inst-001-002', 'task-def-014', 'wf-inst-001', 'completed', '{"id": "user-021", "name": "Charles Clark"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-24T18:00:00Z', '2026-01-24T09:00:00Z', '2026-01-24T15:00:00Z'),
  ('task-inst-001-002-017', 'mod-inst-001-002', 'task-def-017', 'wf-inst-001', 'completed', '{"id": "user-093", "name": "Albert Foster"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-26T18:00:00Z', '2026-01-25T09:00:00Z', '2026-01-25T17:00:00Z'),
  ('task-inst-001-002-019', 'mod-inst-001-002', 'task-def-019', 'wf-inst-001', 'completed', '{"id": "user-093", "name": "Albert Foster"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-27T18:00:00Z', '2026-01-26T09:00:00Z', '2026-01-27T12:00:00Z'),
  ('task-inst-001-002-020', 'mod-inst-001-002', 'task-def-020', 'wf-inst-001', 'completed', '{"id": "user-048", "name": "Kathleen Evans"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-28T18:00:00Z', '2026-01-27T13:00:00Z', '2026-01-27T16:00:00Z'),
  
  -- Task instances for mod-inst-001-003 (Configuration & Setup - in_progress)
  ('task-inst-001-003-021', 'mod-inst-001-003', 'task-def-021', 'wf-inst-001', 'completed', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-28T18:00:00Z', '2026-01-28T09:00:00Z', '2026-01-28T14:00:00Z'),
  ('task-inst-001-003-022', 'mod-inst-001-003', 'task-def-022', 'wf-inst-001', 'completed', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-29T18:00:00Z', '2026-01-29T09:00:00Z', '2026-01-29T15:00:00Z'),
  ('task-inst-001-003-028', 'mod-inst-001-003', 'task-def-028', 'wf-inst-001', 'in_progress', '{"id": "user-035", "name": "Joshua Green"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-30T18:00:00Z', '2026-01-30T09:00:00Z', NULL),
  ('task-inst-001-003-029', 'mod-inst-001-003', 'task-def-029', 'wf-inst-001', 'in_progress', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-02-03T18:00:00Z', '2026-01-30T11:00:00Z', NULL),
  ('task-inst-001-003-030', 'mod-inst-001-003', 'task-def-030', 'wf-inst-001', 'new', NULL, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-02-05T18:00:00Z', NULL, NULL),
  
  -- Task instances for mod-inst-003-001 (Analysis & Investigation - completed)
  ('task-inst-003-001-051', 'mod-inst-003-001', 'task-def-051', 'wf-inst-003', 'completed', '{"id": "user-010", "name": "Patricia Taylor"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-21T18:00:00Z', '2026-01-20T14:30:00Z', '2026-01-21T10:00:00Z'),
  ('task-inst-003-001-052', 'mod-inst-003-001', 'task-def-052', 'wf-inst-003', 'completed', '{"id": "user-004", "name": "Sarah Williams"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-21T18:00:00Z', '2026-01-21T10:30:00Z', '2026-01-21T16:00:00Z'),
  ('task-inst-003-001-053', 'mod-inst-003-001', 'task-def-053', 'wf-inst-003', 'completed', '{"id": "user-028", "name": "Ashley Young"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-23T18:00:00Z', '2026-01-22T09:00:00Z', '2026-01-23T14:00:00Z'),
  ('task-inst-003-001-059', 'mod-inst-003-001', 'task-def-059', 'wf-inst-003', 'completed', '{"id": "user-010", "name": "Patricia Taylor"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-25T18:00:00Z', '2026-01-24T09:00:00Z', '2026-01-25T12:00:00Z'),
  
  -- Task instances for mod-inst-003-002 (Execution & Resolution - in_progress)
  ('task-inst-003-002-061', 'mod-inst-003-002', 'task-def-061', 'wf-inst-003', 'completed', '{"id": "user-042", "name": "Deborah Perez"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-28T18:00:00Z', '2026-01-26T09:00:00Z', '2026-01-28T15:00:00Z'),
  ('task-inst-003-002-065', 'mod-inst-003-002', 'task-def-065', 'wf-inst-003', 'completed', '{"id": "user-053", "name": "Eric Morris"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-30T18:00:00Z', '2026-01-29T09:00:00Z', '2026-01-30T16:00:00Z'),
  ('task-inst-003-002-068', 'mod-inst-003-002', 'task-def-068', 'wf-inst-003', 'in_progress', '{"id": "user-010", "name": "Patricia Taylor"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-31T18:00:00Z', '2026-01-31T09:00:00Z', NULL),
  ('task-inst-003-002-069', 'mod-inst-003-002', 'task-def-069', 'wf-inst-003', 'new', NULL, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-02-07T18:00:00Z', NULL, NULL),
  
  -- Task instances for mod-inst-005-001 through mod-inst-005-005 (Client Onboarding - all completed)
  ('task-inst-005-001-001', 'mod-inst-005-001', 'task-def-001', 'wf-inst-005', 'completed', '{"id": "user-006", "name": "Emily Davis"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-01T18:00:00Z', '2025-12-01T10:00:00Z', '2025-12-01T16:00:00Z'),
  ('task-inst-005-001-003', 'mod-inst-005-001', 'task-def-003', 'wf-inst-005', 'completed', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-02T18:00:00Z', '2025-12-02T09:00:00Z', '2025-12-02T15:00:00Z'),
  ('task-inst-005-002-012', 'mod-inst-005-002', 'task-def-012', 'wf-inst-005', 'completed', '{"id": "user-021", "name": "Charles Clark"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-05T18:00:00Z', '2025-12-05T09:00:00Z', '2025-12-05T16:00:00Z'),
  ('task-inst-005-002-019', 'mod-inst-005-002', 'task-def-019', 'wf-inst-005', 'completed', '{"id": "user-093", "name": "Albert Foster"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-10T18:00:00Z', '2025-12-09T09:00:00Z', '2025-12-10T12:00:00Z'),
  ('task-inst-005-003-021', 'mod-inst-005-003', 'task-def-021', 'wf-inst-005', 'completed', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-12T18:00:00Z', '2025-12-12T09:00:00Z', '2025-12-12T14:00:00Z'),
  ('task-inst-005-003-030', 'mod-inst-005-003', 'task-def-030', 'wf-inst-005', 'completed', '{"id": "user-035", "name": "Joshua Green"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-16T18:00:00Z', '2025-12-16T09:00:00Z', '2025-12-16T17:00:00Z'),
  ('task-inst-005-004-031', 'mod-inst-005-004', 'task-def-031', 'wf-inst-005', 'completed', '{"id": "user-048", "name": "Kathleen Evans"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-18T18:00:00Z', '2025-12-18T09:00:00Z', '2025-12-18T16:00:00Z'),
  ('task-inst-005-004-032', 'mod-inst-005-004', 'task-def-032', 'wf-inst-005', 'completed', '{"id": "user-016", "name": "Karen Martin"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-19T18:00:00Z', '2025-12-19T09:00:00Z', '2025-12-19T17:00:00Z'),
  ('task-inst-005-005-042', 'mod-inst-005-005', 'task-def-042', 'wf-inst-005', 'completed', '{"id": "user-029", "name": "Steven Hernandez"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2025-12-27T18:00:00Z', '2025-12-23T09:00:00Z', '2025-12-27T17:00:00Z'),
  ('task-inst-005-005-046', 'mod-inst-005-005', 'task-def-046', 'wf-inst-005', 'completed', '{"id": "user-006", "name": "Emily Davis"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-03T18:00:00Z', '2026-01-02T09:00:00Z', '2026-01-03T17:00:00Z'),
  ('task-inst-005-005-049', 'mod-inst-005-005', 'task-def-049', 'wf-inst-005', 'completed', '{"id": "user-048", "name": "Kathleen Evans"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-05T18:00:00Z', '2026-01-04T09:00:00Z', '2026-01-05T16:00:00Z'),
  
  -- Task instances for mod-inst-016-001 through mod-inst-016-004 (Support Resolution - all completed)
  ('task-inst-016-001-051', 'mod-inst-016-001', 'task-def-051', 'wf-inst-016', 'completed', '{"id": "user-004", "name": "Sarah Williams"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-05T18:00:00Z', '2026-01-05T15:30:00Z', '2026-01-05T17:00:00Z'),
  ('task-inst-016-001-053', 'mod-inst-016-001', 'task-def-053', 'wf-inst-016', 'completed', '{"id": "user-028", "name": "Ashley Young"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-06T18:00:00Z', '2026-01-06T09:00:00Z', '2026-01-06T14:00:00Z'),
  ('task-inst-016-002-061', 'mod-inst-016-002', 'task-def-061', 'wf-inst-016', 'completed', '{"id": "user-042", "name": "Deborah Perez"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-07T18:00:00Z', '2026-01-06T15:00:00Z', '2026-01-07T16:00:00Z'),
  ('task-inst-016-002-068', 'mod-inst-016-002', 'task-def-068', 'wf-inst-016', 'completed', '{"id": "user-010", "name": "Patricia Taylor"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-08T18:00:00Z', '2026-01-08T09:00:00Z', '2026-01-08T14:00:00Z'),
  ('task-inst-016-002-070', 'mod-inst-016-002', 'task-def-070', 'wf-inst-016', 'completed', '{"id": "user-004", "name": "Sarah Williams"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-08T18:00:00Z', '2026-01-08T15:00:00Z', '2026-01-08T17:00:00Z'),
  ('task-inst-016-003-072', 'mod-inst-016-003', 'task-def-072', 'wf-inst-016', 'completed', '{"id": "user-077", "name": "Christian Bennett"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-07T18:00:00Z', '2026-01-07T10:00:00Z', '2026-01-07T16:00:00Z'),
  ('task-inst-016-003-080', 'mod-inst-016-003', 'task-def-080', 'wf-inst-016', 'completed', '{"id": "user-081", "name": "Jesse Henderson"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-08T18:00:00Z', '2026-01-08T10:00:00Z', '2026-01-08T12:00:00Z'),
  ('task-inst-016-004-082', 'mod-inst-016-004', 'task-def-082', 'wf-inst-016', 'completed', '{"id": "user-010", "name": "Patricia Taylor"}'::jsonb, '{"id": "team-002", "name": "Support Team 24/7"}'::jsonb, '2026-01-08T18:00:00Z', '2026-01-08T13:00:00Z', '2026-01-08T17:00:00Z'),
  
  -- Task instances for mod-inst-021-001 (Discovery & Planning - completed)
  ('task-inst-021-001-001', 'mod-inst-021-001', 'task-def-001', 'wf-inst-021', 'completed', '{"id": "user-035", "name": "Joshua Green"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-30T18:00:00Z', '2026-01-30T09:00:00Z', '2026-01-30T16:00:00Z'),
  ('task-inst-021-001-002', 'mod-inst-021-001', 'task-def-002', 'wf-inst-021', 'completed', '{"id": "user-006", "name": "Emily Davis"}'::jsonb, '{"id": "team-006", "name": "Client Onboarding"}'::jsonb, '2026-01-31T18:00:00Z', '2026-01-31T09:00:00Z', '2026-01-31T17:00:00Z'),
